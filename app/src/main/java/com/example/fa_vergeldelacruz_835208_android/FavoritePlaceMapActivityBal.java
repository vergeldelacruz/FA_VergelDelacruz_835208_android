...
public class FavoritePlaceMapActivityBal extends FragmentActivity implements OnMapReadyCallback {
            ...
            Dialog errorDialog = GoogleApiAvailability.getInstance()
                    .getErrorDialog(this, errorCode, errorCode, new DialogInterface.OnCancelListener() {
                        ...
                        public void onCancel(DialogInterface dialog) {
                            Toast.makeText(FavoritePlaceMapActivityBal.this, "No Services", Toast.LENGTH_SHORT).show();
                        }
                    });
            errorDialog.show();
        } else {
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (permissionsRejected.size() > 0 ) {
                if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                    new AlertDialog.Builder(FavoritePlaceMapActivityBal.this)
